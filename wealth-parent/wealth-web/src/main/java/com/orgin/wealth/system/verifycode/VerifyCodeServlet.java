package com.orgin.wealth.system.verifycode;
...
public class VerifyCodeServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 8960128373072156481L;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < 4; i++) {
            ...
            g.drawString(String.valueOf(codeChar), 12 * i + random.nextInt(7), height - random.nextInt(6));
        }
        ...
        session.setAttribute(SystemConstants.VERIFY_CODE, validationCode.toString());
        // 关闭Graphics对象
        g.dispose();
