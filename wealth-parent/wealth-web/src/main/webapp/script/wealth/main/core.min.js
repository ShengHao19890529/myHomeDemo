...
function widthFunctions(e) {
	...
	var t = $('.navbar, .page-header').outerHeight(), n = $('footer')
			.outerHeight(), r = $(window).height(), i = $(window).width();
			...
			e('.btn-minimize').click(
					function(t) {
						...
						n.is(':visible') ? e('i', e(this)).removeClass(
								'fa-caret-up').addClass('fa-caret-down') : e(
								'i', e(this)).removeClass('fa-caret-down')
