...
(function ($) {
    ...
    BootstrapTable.prototype.initFixedColumns = function () {
        this.$fixedBody = $([
            '<div class="fixed-table-column" style="position: absolute; background-color: #222639; border-right:1px solid #43485b;">',
            '<table>',
            '<thead></thead>',
            '<tbody></tbody>',
            '</table>',
        ...
        this.$fixedBody.find('table').removeClass("table-striped");
        this.$fixedBody.find('table').attr('id', this.$el.attr('id') + "_fixed");
